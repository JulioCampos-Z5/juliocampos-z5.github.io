    ...
    return (
        <div className={cardClass}>
            ...
            <div className="p-4 sm:p-6 flex flex-col flex-grow">
                ...
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-4 flex-grow">{proyecto.descripcion}</p>
                ...
                <div className="flex justify-between items-center mt-auto">
                    ...
                    <span className="text-xs text-gray-500 dark:text-gray-400">{proyecto.fecha}</span>
                </div>
            </div>
        </div>
    );
...
export default function Proyectos() {
    return (
        <section className="mb-16">
            <h2 className="text-3xl font-bold mb-8 text-left text-gray-800 dark:text-gray-100">Proyectos</h2>
            <Carousel

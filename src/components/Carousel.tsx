...
export default function Carousel({ total, mobileCards, desktopCards }: CarouselProps) {
    ...
    const buttonClass =
        'bg-white dark:bg-gray-800 p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-600 disabled:opacity-50 disabled:pointer-events-none';
